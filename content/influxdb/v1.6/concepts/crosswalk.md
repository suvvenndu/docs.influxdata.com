...
* You can [drop or delete a series](/influxdb/v1.6/administration/database_management/#drop-series-from-the-index-with-drop-series), but not individual points based on field values. As a workaround, you can search for the field value, retrieve the time, then [DELETE based on the `time` field](/influxdb/v1.6/administration/database_management/#delete-series-with-delete).
